              ...
              <div className="max-w-4xl mx-auto space-y-8 print:w-full">
                ...
                <div className="border-b-4 border-primary pb-6 text-center">
                  <div className="flex justify-center mb-4">
                     <img src="/logo.png" alt="Smart Inspect" className="h-16" />
                  </div>
                  <h1 className="text-3xl font-black text-slate-900 tracking-wider">Smart Inspect</h1>
                ...
                <div className="text-center pt-8 border-t border-slate-200 text-xs text-slate-400">
                  <p>Generated by Smart Inspect System • {new Date().toLocaleString()}</p>
